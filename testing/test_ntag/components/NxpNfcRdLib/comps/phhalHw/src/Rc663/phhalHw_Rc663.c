                              ...
                              )
{
    ...
    {
        NFCCOMPON_PRINTLINE("ERROR. phhalHw_Rc663_Init PH_ERR_INVALID_DATA_PARAMS");
        return PH_ADD_COMPCODE_FIXED(PH_ERR_INVALID_DATA_PARAMS, PH_COMP_HAL);
    }
    if ((wTxBufSize == 0U) || (wRxBufSize == 0U))
    {
        NFCCOMPON_PRINTLINE("ERROR. phhalHw_Rc663_Init PH_ERR_INVALID_PARAMETER");
