...
// Set LED
//==========================================================================
void LedSet(int8_t aMode, int16_t aCycleCount, bool aDefaultLevel) {
  uint32_t on_time = 0;
  uint32_t off_time = 0;
...
//    if (gLedInfo.mode != aMode) {
    ...
    gLedInfo.defaultLevel = aDefaultLevel;
//    }
    FreeMutex();
  }
